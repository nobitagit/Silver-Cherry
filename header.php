...
<body <?php body_class(); ?>>
	...
	<div id="container" class="container" role="document">
		...
		<!-- This keeps Nav + Main + Aside alltogether -->		
        <div id="main-section-container" class="row" >
        
			<!-- This is the container of nav+main -->
			<div class="eight columns" ><!-- container of nav+main -->
                ...
                <header role="banner">
                    ...
                    <div class="reverie-header">
                    	<hgroup>          
                            <h1><a href="<?php bloginfo('url'); ?>" class="fadeIn" ><?php bloginfo('name'); ?></a></h1>
                            <h4 class="subheader hide-on-phones"><?php bloginfo('description'); ?></h4>
                        </hgroup>
                    </div>
